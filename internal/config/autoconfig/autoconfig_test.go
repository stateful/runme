...
func TestInvokeAll(t *testing.T) {
	...
	// Create a REAEDME.md file in the temp directory.
	err := os.WriteFile(filepath.Join(tempDir, "REAEDME.md"), []byte("Hello, World!"), 0o600)
