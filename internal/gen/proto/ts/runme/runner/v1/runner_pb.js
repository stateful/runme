...
// @generated message type with reflection information, may provide speed optimized methods
class Uri$Type extends MessageType {
    constructor() {
        super("runme.runner.v1.Uri", [
...
class GetBlocksRequest$Type extends MessageType {
    constructor() {
        super("runme.runner.v1.GetBlocksRequest", [
            { no: 1, name: "allow_unnamed", kind: "scalar", opt: true, T: 8 /*ScalarType.BOOL*/ },
            { no: 3, name: "project", kind: "message", T: () => Project }
        ]);
    }
}
...
class GetBlocksResponse$Type extends MessageType {
    constructor() {
        super("runme.runner.v1.GetBlocksResponse", [
            { no: 1, name: "blocks", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Uri }
        ]);
    }
}
/**
