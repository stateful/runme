...
import type { GetBlocksResponse } from "./runner_pb";
import type { GetBlocksRequest } from "./runner_pb";
...
export interface IRunnerServiceClient {
    ...
    /**
     * @generated from protobuf rpc: GetBlocks(runme.runner.v1.GetBlocksRequest) returns (runme.runner.v1.GetBlocksResponse);
     */
