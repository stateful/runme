...
class ResolveVarsRequest$Type extends MessageType {
    constructor() {
        super("runme.runner.v2alpha1.ResolveVarsRequest", [
...
class ResolveVarsRequest_CommandList$Type extends MessageType {
    constructor() {
        super("runme.runner.v2alpha1.ResolveVarsRequest.CommandList", [
...
class ResolveVarsResult$Type extends MessageType {
    constructor() {
        super("runme.runner.v2alpha1.ResolveVarsResult", [
...
class ResolveVarsResponse$Type extends MessageType {
    constructor() {
        super("runme.runner.v2alpha1.ResolveVarsResponse", [
