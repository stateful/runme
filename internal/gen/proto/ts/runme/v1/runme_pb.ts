...
// @generated from file runme/v1/runme.proto (package runme.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from enum runme.v1.CellKind
 */
...
proto3.util.setEnumType(CellKind, "runme.v1.CellKind", [
...
/**
 * @generated from message runme.v1.Notebook
 */
export class Notebook extends Message<Notebook> {
  /**
   * @generated from field: repeated runme.v1.Cell cells = 1;
   */
  cells: Cell[] = [];
  ...
  static readonly typeName = "runme.v1.Notebook";
...
/**
 * @generated from message runme.v1.Cell
 */
export class Cell extends Message<Cell> {
  /**
   * @generated from field: runme.v1.CellKind kind = 1;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "runme.v1.Cell";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message runme.v1.DeserializeRequest
 */
export class DeserializeRequest extends Message<DeserializeRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "runme.v1.DeserializeRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message runme.v1.DeserializeResponse
 */
export class DeserializeResponse extends Message<DeserializeResponse> {
  /**
   * @generated from field: runme.v1.Notebook notebook = 1;
   */
  notebook?: Notebook;
  ...
  static readonly runtime = proto3;
  static readonly typeName = "runme.v1.DeserializeResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message runme.v1.SerializeRequest
 */
export class SerializeRequest extends Message<SerializeRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "runme.v1.SerializeRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "notebook", kind: "message", T: Notebook },
  ]);
...
/**
 * @generated from message runme.v1.SerializeResponse
 */
export class SerializeResponse extends Message<SerializeResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "runme.v1.SerializeResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
