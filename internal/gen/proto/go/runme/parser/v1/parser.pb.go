...
var file_runme_parser_v1_parser_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_runme_parser_v1_parser_proto_goTypes = []interface{}{
	...
	(*DeserializeRequest)(nil),  // 4: runme.parser.v1.DeserializeRequest
	(*DeserializeResponse)(nil), // 5: runme.parser.v1.DeserializeResponse
	(*SerializeRequest)(nil),    // 6: runme.parser.v1.SerializeRequest
	(*SerializeResponse)(nil),   // 7: runme.parser.v1.SerializeResponse
	nil,                         // 8: runme.parser.v1.Notebook.MetadataEntry
	nil,                         // 9: runme.parser.v1.Cell.MetadataEntry
}
var file_runme_parser_v1_parser_proto_depIdxs = []int32{
	3, // 0: runme.parser.v1.Notebook.cells:type_name -> runme.parser.v1.Cell
	8, // 1: runme.parser.v1.Notebook.metadata:type_name -> runme.parser.v1.Notebook.MetadataEntry
	0, // 2: runme.parser.v1.Cell.kind:type_name -> runme.parser.v1.CellKind
	9, // 3: runme.parser.v1.Cell.metadata:type_name -> runme.parser.v1.Cell.MetadataEntry
	2, // 4: runme.parser.v1.Cell.text_range:type_name -> runme.parser.v1.TextRange
	1, // 5: runme.parser.v1.DeserializeResponse.notebook:type_name -> runme.parser.v1.Notebook
	1, // 6: runme.parser.v1.SerializeRequest.notebook:type_name -> runme.parser.v1.Notebook
	4, // 7: runme.parser.v1.ParserService.Deserialize:input_type -> runme.parser.v1.DeserializeRequest
	6, // 8: runme.parser.v1.ParserService.Serialize:input_type -> runme.parser.v1.SerializeRequest
	5, // 9: runme.parser.v1.ParserService.Deserialize:output_type -> runme.parser.v1.DeserializeResponse
	7, // 10: runme.parser.v1.ParserService.Serialize:output_type -> runme.parser.v1.SerializeResponse
