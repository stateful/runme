...
type SerializeRequest struct {
	...
	Notebook *Notebook     `protobuf:"bytes,1,opt,name=notebook,proto3" json:"notebook,omitempty"`
	Identity RunmeIdentity `protobuf:"varint,2,opt,name=identity,proto3,enum=runme.parser.v1.RunmeIdentity" json:"identity,omitempty"`
}
...
func (x *SerializeRequest) GetIdentity() RunmeIdentity {
	if x != nil {
		return x.Identity
	}
...
var file_runme_parser_v1_parser_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x31, 0x0a, 0x05, 0x52, 0x75, 0x6e, 0x6d,
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x86, 0x01, 0x0a, 0x0b,
	...
	0x75, 0x6e, 0x6d, 0x65, 0x22, 0x2c, 0x0a, 0x12, 0x44, 0x65, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c,
	...
	0x63, 0x65, 0x22, 0x4c, 0x0a, 0x13, 0x44, 0x65, 0x73, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x35, 0x0a, 0x08, 0x6e, 0x6f, 0x74,
	...
	0x22, 0x85, 0x01, 0x0a, 0x10, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x69, 0x7a, 0x65, 0x52, 0x65,
	...
	0x6f, 0x6b, 0x52, 0x08, 0x6e, 0x6f, 0x74, 0x65, 0x62, 0x6f, 0x6f, 0x6b, 0x12, 0x3a, 0x0a, 0x08,
	0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e,
	...
	0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x2b, 0x0a, 0x11, 0x53, 0x65, 0x72, 0x69,
...
var file_runme_parser_v1_parser_proto_goTypes = []interface{}{
	...
	(*Runme)(nil),               // 5: runme.parser.v1.Runme
...
var file_runme_parser_v1_parser_proto_depIdxs = []int32{
	...
	5,  // 6: runme.parser.v1.Frontmatter.runme:type_name -> runme.parser.v1.Runme
	2,  // 7: runme.parser.v1.DeserializeResponse.notebook:type_name -> runme.parser.v1.Notebook
	2,  // 8: runme.parser.v1.SerializeRequest.notebook:type_name -> runme.parser.v1.Notebook
	1,  // 9: runme.parser.v1.SerializeRequest.identity:type_name -> runme.parser.v1.RunmeIdentity
