...
type SessionEnvStore int32

const (
	// uses default env store
	SessionEnvStore_SESSION_ENV_STORE_UNSPECIFIED SessionEnvStore = 0
	// uses owl store
	SessionEnvStore_SESSION_ENV_STORE_OWL SessionEnvStore = 1
)

// Enum value maps for SessionEnvStore.
var (
	SessionEnvStore_name = map[int32]string{
		0: "SESSION_ENV_STORE_UNSPECIFIED",
		1: "SESSION_ENV_STORE_OWL",
	}
	SessionEnvStore_value = map[string]int32{
		"SESSION_ENV_STORE_UNSPECIFIED": 0,
		"SESSION_ENV_STORE_OWL":         1,
	}
)

func (x SessionEnvStore) Enum() *SessionEnvStore {
	p := new(SessionEnvStore)
	*p = x
	return p
}

func (x SessionEnvStore) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SessionEnvStore) Descriptor() protoreflect.EnumDescriptor {
	return file_runme_runner_v1_runner_proto_enumTypes[0].Descriptor()
}

func (SessionEnvStore) Type() protoreflect.EnumType {
	return &file_runme_runner_v1_runner_proto_enumTypes[0]
}

func (x SessionEnvStore) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SessionEnvStore.Descriptor instead.
func (SessionEnvStore) EnumDescriptor() ([]byte, []int) {
...
type MonitorEnvType int32

const (
	MonitorEnvType_MONITOR_ENV_TYPE_UNSPECIFIED MonitorEnvType = 0
	MonitorEnvType_MONITOR_ENV_TYPE_SNAPSHOT    MonitorEnvType = 1
)

// Enum value maps for MonitorEnvType.
var (
	MonitorEnvType_name = map[int32]string{
		0: "MONITOR_ENV_TYPE_UNSPECIFIED",
		1: "MONITOR_ENV_TYPE_SNAPSHOT",
	}
	MonitorEnvType_value = map[string]int32{
		"MONITOR_ENV_TYPE_UNSPECIFIED": 0,
		"MONITOR_ENV_TYPE_SNAPSHOT":    1,
	}
)

func (x MonitorEnvType) Enum() *MonitorEnvType {
	p := new(MonitorEnvType)
	*p = x
	return p
}

func (x MonitorEnvType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MonitorEnvType) Descriptor() protoreflect.EnumDescriptor {
	return file_runme_runner_v1_runner_proto_enumTypes[4].Descriptor()
}

func (MonitorEnvType) Type() protoreflect.EnumType {
	return &file_runme_runner_v1_runner_proto_enumTypes[4]
}

func (x MonitorEnvType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MonitorEnvType.Descriptor instead.
func (MonitorEnvType) EnumDescriptor() ([]byte, []int) {
...
type MonitorEnvResponseSnapshot_Status int32

const (
	MonitorEnvResponseSnapshot_STATUS_UNSPECIFIED MonitorEnvResponseSnapshot_Status = 0
	MonitorEnvResponseSnapshot_STATUS_LITERAL     MonitorEnvResponseSnapshot_Status = 1
	MonitorEnvResponseSnapshot_STATUS_HIDDEN      MonitorEnvResponseSnapshot_Status = 2
	MonitorEnvResponseSnapshot_STATUS_MASKED      MonitorEnvResponseSnapshot_Status = 3
)

// Enum value maps for MonitorEnvResponseSnapshot_Status.
var (
	MonitorEnvResponseSnapshot_Status_name = map[int32]string{
		0: "STATUS_UNSPECIFIED",
		1: "STATUS_LITERAL",
		2: "STATUS_HIDDEN",
		3: "STATUS_MASKED",
	}
	MonitorEnvResponseSnapshot_Status_value = map[string]int32{
		"STATUS_UNSPECIFIED": 0,
		"STATUS_LITERAL":     1,
		"STATUS_HIDDEN":      2,
		"STATUS_MASKED":      3,
...
func (x MonitorEnvResponseSnapshot_Status) Enum() *MonitorEnvResponseSnapshot_Status {
	p := new(MonitorEnvResponseSnapshot_Status)
	*p = x
	return p
}

func (x MonitorEnvResponseSnapshot_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MonitorEnvResponseSnapshot_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_runme_runner_v1_runner_proto_enumTypes[7].Descriptor()
}

func (MonitorEnvResponseSnapshot_Status) Type() protoreflect.EnumType {
	return &file_runme_runner_v1_runner_proto_enumTypes[7]
}

func (x MonitorEnvResponseSnapshot_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MonitorEnvResponseSnapshot_Status.Descriptor instead.
func (MonitorEnvResponseSnapshot_Status) EnumDescriptor() ([]byte, []int) {
...
type CreateSessionRequest struct {
	...
	EnvStore *SessionEnvStore `protobuf:"varint,4,opt,name=env_store,json=envStore,proto3,enum=runme.runner.v1.SessionEnvStore,oneof" json:"env_store,omitempty"`
}
...
func (x *CreateSessionRequest) GetEnvStore() SessionEnvStore {
	if x != nil && x.EnvStore != nil {
		return *x.EnvStore
	}
	return SessionEnvStore_SESSION_ENV_STORE_UNSPECIFIED
}
...
func (x *MonitorEnvRequest) Reset() {
	*x = MonitorEnvRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *MonitorEnvRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MonitorEnvRequest) ProtoMessage() {}

func (x *MonitorEnvRequest) ProtoReflect() protoreflect.Message {
	mi := &file_runme_runner_v1_runner_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MonitorEnvRequest.ProtoReflect.Descriptor instead.
func (*MonitorEnvRequest) Descriptor() ([]byte, []int) {
	return file_runme_runner_v1_runner_proto_rawDescGZIP(), []int{17}
}

func (x *MonitorEnvRequest) GetSession() *Session {
	if x != nil {
		return x.Session
	}
	return nil
...
type MonitorEnvResponseSnapshot struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Envs []*MonitorEnvResponseSnapshot_SnapshotEnv `protobuf:"bytes,1,rep,name=envs,proto3" json:"envs,omitempty"`
}

func (x *MonitorEnvResponseSnapshot) Reset() {
	*x = MonitorEnvResponseSnapshot{}
	if protoimpl.UnsafeEnabled {
...
func (x *MonitorEnvResponseSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MonitorEnvResponseSnapshot) ProtoMessage() {}

func (x *MonitorEnvResponseSnapshot) ProtoReflect() protoreflect.Message {
	mi := &file_runme_runner_v1_runner_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MonitorEnvResponseSnapshot.ProtoReflect.Descriptor instead.
func (*MonitorEnvResponseSnapshot) Descriptor() ([]byte, []int) {
	return file_runme_runner_v1_runner_proto_rawDescGZIP(), []int{18}
}

func (x *MonitorEnvResponseSnapshot) GetEnvs() []*MonitorEnvResponseSnapshot_SnapshotEnv {
	if x != nil {
		return x.Envs
	}
	return nil
...
type MonitorEnvResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type MonitorEnvType `protobuf:"varint,1,opt,name=type,proto3,enum=runme.runner.v1.MonitorEnvType" json:"type,omitempty"`
	// Types that are assignable to Data:
	//
	//	*MonitorEnvResponse_Snapshot
	Data isMonitorEnvResponse_Data `protobuf_oneof:"data"`
}

func (x *MonitorEnvResponse) Reset() {
	*x = MonitorEnvResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *MonitorEnvResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MonitorEnvResponse) ProtoMessage() {}

func (x *MonitorEnvResponse) ProtoReflect() protoreflect.Message {
	mi := &file_runme_runner_v1_runner_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MonitorEnvResponse.ProtoReflect.Descriptor instead.
func (*MonitorEnvResponse) Descriptor() ([]byte, []int) {
	return file_runme_runner_v1_runner_proto_rawDescGZIP(), []int{19}
}

func (x *MonitorEnvResponse) GetType() MonitorEnvType {
	if x != nil {
		return x.Type
	}
	return MonitorEnvType_MONITOR_ENV_TYPE_UNSPECIFIED
}

func (m *MonitorEnvResponse) GetData() isMonitorEnvResponse_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (x *MonitorEnvResponse) GetSnapshot() *MonitorEnvResponseSnapshot {
	if x, ok := x.GetData().(*MonitorEnvResponse_Snapshot); ok {
		return x.Snapshot
	}
	return nil
}

type isMonitorEnvResponse_Data interface {
	isMonitorEnvResponse_Data()
}

type MonitorEnvResponse_Snapshot struct {
	Snapshot *MonitorEnvResponseSnapshot `protobuf:"bytes,2,opt,name=snapshot,proto3,oneof"`
}

func (*MonitorEnvResponse_Snapshot) isMonitorEnvResponse_Data() {}
...
type MonitorEnvResponseSnapshot_SnapshotEnv struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Status        MonitorEnvResponseSnapshot_Status `protobuf:"varint,1,opt,name=status,proto3,enum=runme.runner.v1.MonitorEnvResponseSnapshot_Status" json:"status,omitempty"`
	Name          string                            `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	Spec          string                            `protobuf:"bytes,3,opt,name=spec,proto3" json:"spec,omitempty"`
	OriginalValue string                            `protobuf:"bytes,4,opt,name=original_value,json=originalValue,proto3" json:"original_value,omitempty"`
	ResolvedValue string                            `protobuf:"bytes,5,opt,name=resolved_value,json=resolvedValue,proto3" json:"resolved_value,omitempty"`
}

func (x *MonitorEnvResponseSnapshot_SnapshotEnv) Reset() {
	*x = MonitorEnvResponseSnapshot_SnapshotEnv{}
	if protoimpl.UnsafeEnabled {
...
func (x *MonitorEnvResponseSnapshot_SnapshotEnv) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MonitorEnvResponseSnapshot_SnapshotEnv) ProtoMessage() {}

func (x *MonitorEnvResponseSnapshot_SnapshotEnv) ProtoReflect() protoreflect.Message {
	mi := &file_runme_runner_v1_runner_proto_msgTypes[23]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MonitorEnvResponseSnapshot_SnapshotEnv.ProtoReflect.Descriptor instead.
func (*MonitorEnvResponseSnapshot_SnapshotEnv) Descriptor() ([]byte, []int) {
	return file_runme_runner_v1_runner_proto_rawDescGZIP(), []int{18, 0}
}

func (x *MonitorEnvResponseSnapshot_SnapshotEnv) GetStatus() MonitorEnvResponseSnapshot_Status {
	if x != nil {
		return x.Status
	}
	return MonitorEnvResponseSnapshot_STATUS_UNSPECIFIED
}

func (x *MonitorEnvResponseSnapshot_SnapshotEnv) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *MonitorEnvResponseSnapshot_SnapshotEnv) GetSpec() string {
	if x != nil {
		return x.Spec
	}
	return ""
...
func (x *MonitorEnvResponseSnapshot_SnapshotEnv) GetOriginalValue() string {
	if x != nil {
		return x.OriginalValue
	}
	return ""
...
func (x *MonitorEnvResponseSnapshot_SnapshotEnv) GetResolvedValue() string {
	if x != nil {
		return x.ResolvedValue
	}
	return ""
...
var file_runme_runner_v1_runner_proto_rawDesc = []byte{
	...
	0x22, 0xcf, 0x02, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	0x6a, 0x65, 0x63, 0x74, 0x88, 0x01, 0x01, 0x12, 0x42, 0x0a, 0x09, 0x65, 0x6e, 0x76, 0x5f, 0x73,
	0x74, 0x6f, 0x72, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x72, 0x75, 0x6e,
	0x6d, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x76, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x48, 0x01, 0x52, 0x08,
	0x65, 0x6e, 0x76, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x88, 0x01, 0x01, 0x1a, 0x3b, 0x0a, 0x0d, 0x4d,
	...
	0x6a, 0x65, 0x63, 0x74, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x65, 0x6e, 0x76, 0x5f, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x22, 0x4b, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x65, 0x73, 0x73,
	...
	0x52, 0x02, 0x69, 0x64, 0x22, 0x48, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x53, 0x65, 0x73, 0x73, 0x69,
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4c, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x73,
	...
	0x6f, 0x6e, 0x73, 0x22, 0x26, 0x0a, 0x14, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x65, 0x73,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x43, 0x0a, 0x07, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12,
	0x12, 0x0a, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72,
	0x6f, 0x6f, 0x74, 0x12, 0x24, 0x0a, 0x0e, 0x65, 0x6e, 0x76, 0x5f, 0x6c, 0x6f, 0x61, 0x64, 0x5f,
	0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0c, 0x65, 0x6e, 0x76,
	0x4c, 0x6f, 0x61, 0x64, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x4d, 0x0a, 0x07, 0x57, 0x69, 0x6e,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x63, 0x6f, 0x6c, 0x73, 0x12, 0x0c, 0x0a, 0x01,
	0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x78, 0x12, 0x0c, 0x0a, 0x01, 0x79, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x79, 0x22, 0xe5, 0x05, 0x0a, 0x0e, 0x45, 0x78, 0x65,
	0x63, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x70,
	0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1c,
	...
	,
	...
	0x79, 0x18, 0x15, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x16, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x72, 0x75,
	...
	0x88, 0x01, 0x01, 0x12, 0x2a, 0x0a, 0x11, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x6c, 0x61, 0x73,
	0x74, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x18, 0x17, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x4c, 0x61, 0x73, 0x74, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x12,
	0x3f, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18,
	0x18, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e, 0x72, 0x75,
	...
	,
	...
	0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x64, 0x6f, 0x75, 0x74, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02,
	...
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x73, 0x74, 0x64, 0x65, 0x72, 0x72, 0x44, 0x61, 0x74,
	0x61, 0x12, 0x2d, 0x0a, 0x03, 0x70, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b,
	...
	0x6e, 0x65, 0x73, 0x22, 0xcf, 0x03, 0x0a, 0x15, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x50,
	...
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x88, 0x01, 0x01, 0x22, 0x44, 0x0a, 0x04, 0x4d, 0x6f, 0x64,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0xfb, 0x03, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76,
	...
	0x44, 0x10, 0x03, 0x22, 0x47, 0x0a, 0x11, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72, 0x45, 0x6e,
	0x76, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x07, 0x73, 0x65, 0x73, 0x73,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x70, 0x65, 0x63, 0x12, 0x25, 0x0a, 0x0e,
	0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x61, 0x6c, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x04,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x72, 0x65, 0x73,
	0x6f, 0x6c, 0x76, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x5a, 0x0a, 0x06, 0x53, 0x74,
	...
	,
	...
	0x5f, 0x4f, 0x57, 0x4c, 0x10, 0x01, 0x2a, 0x5e, 0x0a, 0x0b, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74,
	0x65, 0x53, 0x74, 0x6f, 0x70, 0x12, 0x1c, 0x0a, 0x18, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x45,
	0x5f, 0x53, 0x54, 0x4f, 0x50, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45,
	0x44, 0x10, 0x00, 0x12, 0x1a, 0x0a, 0x16, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x45, 0x5f, 0x53,
	0x54, 0x4f, 0x50, 0x5f, 0x49, 0x4e, 0x54, 0x45, 0x52, 0x52, 0x55, 0x50, 0x54, 0x10, 0x01, 0x12,
	0x15, 0x0a, 0x11, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x45, 0x5f, 0x53, 0x54, 0x4f, 0x50, 0x5f,
	0x4b, 0x49, 0x4c, 0x4c, 0x10, 0x02, 0x2a, 0x66, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e,
	...
	0x44, 0x45, 0x5f, 0x54, 0x45, 0x4d, 0x50, 0x5f, 0x46, 0x49, 0x4c, 0x45, 0x10, 0x02, 0x2a, 0x55,
	...
	0x45, 0x4e, 0x54, 0x10, 0x01, 0x2a, 0x51, 0x0a, 0x0e, 0x4d, 0x6f, 0x6e, 0x69, 0x74, 0x6f, 0x72,
	0x45, 0x6e, 0x76, 0x54, 0x79, 0x70, 0x65, 0x12, 0x20, 0x0a, 0x1c, 0x4d, 0x4f, 0x4e, 0x49, 0x54,
	0x4f, 0x52, 0x5f, 0x45, 0x4e, 0x56, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50,
	0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x1d, 0x0a, 0x19, 0x4d, 0x4f, 0x4e,
	0x49, 0x54, 0x4f, 0x52, 0x5f, 0x45, 0x4e, 0x56, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x53, 0x4e,
	0x41, 0x50, 0x53, 0x48, 0x4f, 0x54, 0x10, 0x01, 0x32, 0x9f, 0x05, 0x0a, 0x0d, 0x52, 0x75, 0x6e,
	...
	,
	...
	0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x63, 0x0a, 0x0e, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65,
	0x50, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d, 0x12, 0x26, 0x2e, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e,
	...
	0x27, 0x2e, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76,
	0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x61, 0x6d,
	...
	0x6c, 0x2f, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2f, 0x76, 0x33, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f,
	0x2f, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2f, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2f, 0x76, 0x31,
	0x3b, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_runme_runner_v1_runner_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_runme_runner_v1_runner_proto_goTypes = []interface{}{
	(SessionEnvStore)(0),                           // 0: runme.runner.v1.SessionEnvStore
	...
	(MonitorEnvType)(0),                            // 4: runme.runner.v1.MonitorEnvType
	...
	(MonitorEnvResponseSnapshot_Status)(0),         // 7: runme.runner.v1.MonitorEnvResponseSnapshot.Status
	...
	(*MonitorEnvRequest)(nil),                      // 25: runme.runner.v1.MonitorEnvRequest
	(*MonitorEnvResponseSnapshot)(nil),             // 26: runme.runner.v1.MonitorEnvResponseSnapshot
	(*MonitorEnvResponse)(nil),                     // 27: runme.runner.v1.MonitorEnvResponse
	...
	(*MonitorEnvResponseSnapshot_SnapshotEnv)(nil), // 31: runme.runner.v1.MonitorEnvResponseSnapshot.SnapshotEnv
...
var file_runme_runner_v1_runner_proto_depIdxs = []int32{
	...
	17, // 2: runme.runner.v1.CreateSessionRequest.project:type_name -> runme.runner.v1.Project
	0,  // 3: runme.runner.v1.CreateSessionRequest.env_store:type_name -> runme.runner.v1.SessionEnvStore
	8,  // 4: runme.runner.v1.CreateSessionResponse.session:type_name -> runme.runner.v1.Session
	8,  // 5: runme.runner.v1.GetSessionResponse.session:type_name -> runme.runner.v1.Session
	8,  // 6: runme.runner.v1.ListSessionsResponse.sessions:type_name -> runme.runner.v1.Session
	1,  // 7: runme.runner.v1.ExecuteRequest.stop:type_name -> runme.runner.v1.ExecuteStop
	18, // 8: runme.runner.v1.ExecuteRequest.winsize:type_name -> runme.runner.v1.Winsize
	3,  // 9: runme.runner.v1.ExecuteRequest.session_strategy:type_name -> runme.runner.v1.SessionStrategy
	17, // 10: runme.runner.v1.ExecuteRequest.project:type_name -> runme.runner.v1.Project
	2,  // 11: runme.runner.v1.ExecuteRequest.command_mode:type_name -> runme.runner.v1.CommandMode
	32, // 12: runme.runner.v1.ExecuteResponse.exit_code:type_name -> google.protobuf.UInt32Value
	20, // 13: runme.runner.v1.ExecuteResponse.pid:type_name -> runme.runner.v1.ProcessPID
	22, // 14: runme.runner.v1.ResolveProgramRequest.commands:type_name -> runme.runner.v1.ResolveProgramCommandList
	...
	17, // 17: runme.runner.v1.ResolveProgramRequest.project:type_name -> runme.runner.v1.Project
	22, // 18: runme.runner.v1.ResolveProgramResponse.commands:type_name -> runme.runner.v1.ResolveProgramCommandList
	30, // 19: runme.runner.v1.ResolveProgramResponse.vars:type_name -> runme.runner.v1.ResolveProgramResponse.VarResult
	8,  // 20: runme.runner.v1.MonitorEnvRequest.session:type_name -> runme.runner.v1.Session
	31, // 21: runme.runner.v1.MonitorEnvResponseSnapshot.envs:type_name -> runme.runner.v1.MonitorEnvResponseSnapshot.SnapshotEnv
	4,  // 22: runme.runner.v1.MonitorEnvResponse.type:type_name -> runme.runner.v1.MonitorEnvType
	26, // 23: runme.runner.v1.MonitorEnvResponse.snapshot:type_name -> runme.runner.v1.MonitorEnvResponseSnapshot
	6,  // 24: runme.runner.v1.ResolveProgramResponse.VarResult.status:type_name -> runme.runner.v1.ResolveProgramResponse.Status
	7,  // 25: runme.runner.v1.MonitorEnvResponseSnapshot.SnapshotEnv.status:type_name -> runme.runner.v1.MonitorEnvResponseSnapshot.Status
	9,  // 26: runme.runner.v1.RunnerService.CreateSession:input_type -> runme.runner.v1.CreateSessionRequest
	11, // 27: runme.runner.v1.RunnerService.GetSession:input_type -> runme.runner.v1.GetSessionRequest
	13, // 28: runme.runner.v1.RunnerService.ListSessions:input_type -> runme.runner.v1.ListSessionsRequest
	15, // 29: runme.runner.v1.RunnerService.DeleteSession:input_type -> runme.runner.v1.DeleteSessionRequest
	25, // 30: runme.runner.v1.RunnerService.MonitorEnv:input_type -> runme.runner.v1.MonitorEnvRequest
	19, // 31: runme.runner.v1.RunnerService.Execute:input_type -> runme.runner.v1.ExecuteRequest
	23, // 32: runme.runner.v1.RunnerService.ResolveProgram:input_type -> runme.runner.v1.ResolveProgramRequest
	10, // 33: runme.runner.v1.RunnerService.CreateSession:output_type -> runme.runner.v1.CreateSessionResponse
	12, // 34: runme.runner.v1.RunnerService.GetSession:output_type -> runme.runner.v1.GetSessionResponse
	14, // 35: runme.runner.v1.RunnerService.ListSessions:output_type -> runme.runner.v1.ListSessionsResponse
	16, // 36: runme.runner.v1.RunnerService.DeleteSession:output_type -> runme.runner.v1.DeleteSessionResponse
	27, // 37: runme.runner.v1.RunnerService.MonitorEnv:output_type -> runme.runner.v1.MonitorEnvResponse
	21, // 38: runme.runner.v1.RunnerService.Execute:output_type -> runme.runner.v1.ExecuteResponse
	24, // 39: runme.runner.v1.RunnerService.ResolveProgram:output_type -> runme.runner.v1.ResolveProgramResponse
...
func file_runme_runner_v1_runner_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_runme_runner_v1_runner_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MonitorEnvRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_runme_runner_v1_runner_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MonitorEnvResponseSnapshot); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_runme_runner_v1_runner_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MonitorEnvResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_runme_runner_v1_runner_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_runme_runner_v1_runner_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MonitorEnvResponseSnapshot_SnapshotEnv); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_runme_runner_v1_runner_proto_msgTypes[19].OneofWrappers = []interface{}{
		(*MonitorEnvResponse_Snapshot)(nil),
	}
	type x struct{}
