...
class ResolveProgramRequest$Type extends MessageType {
    constructor() {
        super("runme.runner.v2.ResolveProgramRequest", [
            ...
            { no: 9, name: "var_retention_strategy", kind: "enum", T: () => ["runme.runner.v2.ResolveProgramRequest.VarRetentionStrategy", ResolveProgramRequest_VarRetentionStrategy, "VAR_RETENTION_STRATEGY_"] }
        ]);
    }
}
/**
