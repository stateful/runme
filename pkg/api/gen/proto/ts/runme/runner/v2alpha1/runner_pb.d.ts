...
export interface ResolveProgramRequest {
     ...
     *
     * @generated from protobuf field: runme.runner.v2alpha1.ResolveProgramRequest.Mode mode = 3;
     */
...
/**
 * @generated from protobuf message runme.runner.v2alpha1.ResolveProgramResponse.VarResult
 */
export interface ResolveProgramResponse_VarResult {
    /**
     * prompt indicates the resolution status of the env variable.
     *
     * @generated from protobuf field: runme.runner.v2alpha1.ResolveProgramResponse.Status status = 1;
     */
...
export interface MonitorEnvStoreResponseSnapshot_SnapshotEnv {
    ...
    updateTime: string;
    /**
     * @generated from protobuf field: repeated runme.runner.v2alpha1.MonitorEnvStoreResponseSnapshot.Error errors = 10;
     */
