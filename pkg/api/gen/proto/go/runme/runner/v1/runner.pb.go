...
const (
	...
	CommandMode_COMMAND_MODE_DAGGER_SHELL CommandMode = 4
)
...
type ResolveNotebookResponse_Status int32

const (
	// unspecified is the default value and it means unresolved.
	ResolveNotebookResponse_STATUS_UNSPECIFIED ResolveNotebookResponse_Status = 0
	// unresolved with message means that the variable is unresolved
	// but it contains a message. E.g. FOO=this is message
	ResolveNotebookResponse_STATUS_UNRESOLVED_WITH_MESSAGE ResolveNotebookResponse_Status = 1
	// unresolved with placeholder means that the variable is unresolved
	// but it contains a placeholder. E.g. FOO="this is placeholder"
	ResolveNotebookResponse_STATUS_UNRESOLVED_WITH_PLACEHOLDER ResolveNotebookResponse_Status = 2
	// resolved means that the variable is resolved.
	ResolveNotebookResponse_STATUS_RESOLVED ResolveNotebookResponse_Status = 3
	// unresolved with secret means that the variable is unresolved
	// and it requires treatment as a secret.
	ResolveNotebookResponse_STATUS_UNRESOLVED_WITH_SECRET ResolveNotebookResponse_Status = 4
)

// Enum value maps for ResolveNotebookResponse_Status.
var (
	ResolveNotebookResponse_Status_name = map[int32]string{
		0: "STATUS_UNSPECIFIED",
		1: "STATUS_UNRESOLVED_WITH_MESSAGE",
		2: "STATUS_UNRESOLVED_WITH_PLACEHOLDER",
		3: "STATUS_RESOLVED",
	...
	ResolveNotebookResponse_Status_value = map[string]int32{
		"STATUS_UNSPECIFIED":                 0,
		"STATUS_UNRESOLVED_WITH_MESSAGE":     1,
		"STATUS_UNRESOLVED_WITH_PLACEHOLDER": 2,
		"STATUS_RESOLVED":                    3,
...
func (x ResolveNotebookResponse_Status) Enum() *ResolveNotebookResponse_Status {
	p := new(ResolveNotebookResponse_Status)
	*p = x
	return p
}

func (x ResolveNotebookResponse_Status) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ResolveNotebookResponse_Status) Descriptor() protoreflect.EnumDescriptor {
	return file_runme_runner_v1_runner_proto_enumTypes[8].Descriptor()
}

func (ResolveNotebookResponse_Status) Type() protoreflect.EnumType {
	return &file_runme_runner_v1_runner_proto_enumTypes[8]
}

func (x ResolveNotebookResponse_Status) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ResolveNotebookResponse_Status.Descriptor instead.
func (ResolveNotebookResponse_Status) EnumDescriptor() ([]byte, []int) {
	return file_runme_runner_v1_runner_proto_rawDescGZIP(), []int{21, 0}
}
...
type ResolveNotebookRequest struct {
	...
	//
	//	*ResolveNotebookRequest_KnownId
	//	*ResolveNotebookRequest_KnownName
	//	*ResolveNotebookRequest_CellIndex
	Target isResolveNotebookRequest_Target `protobuf_oneof:"target"`
	// env is a list of explicit environment variables that will be used
	// to resolve the environment variables found in the source.
	...
	// session_strategy is a strategy for selecting the session.
	SessionStrategy SessionStrategy `protobuf:"varint,7,opt,name=session_strategy,json=sessionStrategy,proto3,enum=runme.runner.v1.SessionStrategy" json:"session_strategy,omitempty"`
	// project used to load environment variables from .env files.
	Project *Project `protobuf:"bytes,8,opt,name=project,proto3,oneof" json:"project,omitempty"`
	// language id associated with script
...
func (x *ResolveNotebookRequest) Reset() {
	*x = ResolveNotebookRequest{}
	mi := &file_runme_runner_v1_runner_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResolveNotebookRequest) Descriptor() ([]byte, []int) {
	return file_runme_runner_v1_runner_proto_rawDescGZIP(), []int{20}
}
...
func (x *ResolveNotebookRequest) GetTarget() isResolveNotebookRequest_Target {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *ResolveNotebookRequest) GetKnownId() string {
	if x != nil {
		if x, ok := x.Target.(*ResolveNotebookRequest_KnownId); ok {
			return x.KnownId
		}
	}
	return ""
...
func (x *ResolveNotebookRequest) GetKnownName() string {
	if x != nil {
		if x, ok := x.Target.(*ResolveNotebookRequest_KnownName); ok {
			return x.KnownName
		}
	}
	return ""
...
func (x *ResolveNotebookRequest) GetCellIndex() uint32 {
	if x != nil {
		if x, ok := x.Target.(*ResolveNotebookRequest_CellIndex); ok {
			return x.CellIndex
		}
	}
	return 0
...
func (x *ResolveNotebookRequest) GetEnv() []string {
	if x != nil {
		return x.Env
	}
	return nil
...
func (x *ResolveNotebookRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *ResolveNotebookRequest) GetSessionStrategy() SessionStrategy {
	if x != nil {
		return x.SessionStrategy
	}
	return SessionStrategy_SESSION_STRATEGY_UNSPECIFIED
...
func (x *ResolveNotebookRequest) GetProject() *Project {
	if x != nil {
		return x.Project
	}
	return nil
...
func (x *ResolveNotebookRequest) GetLanguageId() string {
	if x != nil {
		return x.LanguageId
	}
	return ""
...
type isResolveNotebookRequest_Target interface {
	isResolveNotebookRequest_Target()
}

type ResolveNotebookRequest_KnownId struct {
	KnownId string `protobuf:"bytes,2,opt,name=known_id,json=knownId,proto3,oneof"`
}

type ResolveNotebookRequest_KnownName struct {
	KnownName string `protobuf:"bytes,3,opt,name=known_name,json=knownName,proto3,oneof"`
}

type ResolveNotebookRequest_CellIndex struct {
	CellIndex uint32 `protobuf:"varint,4,opt,name=cell_index,json=cellIndex,proto3,oneof"`
}

func (*ResolveNotebookRequest_KnownId) isResolveNotebookRequest_Target() {}

func (*ResolveNotebookRequest_KnownName) isResolveNotebookRequest_Target() {}

func (*ResolveNotebookRequest_CellIndex) isResolveNotebookRequest_Target() {}
...
type ResolveNotebookResponse struct {
	...
	// use script until commands normalization is implemented
	Commands      *ResolveProgramCommandList           `protobuf:"bytes,2,opt,name=commands,proto3" json:"commands,omitempty"`
	Vars          []*ResolveNotebookResponse_VarResult `protobuf:"bytes,3,rep,name=vars,proto3" json:"vars,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResolveNotebookResponse) Reset() {
	*x = ResolveNotebookResponse{}
	mi := &file_runme_runner_v1_runner_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResolveNotebookResponse) Descriptor() ([]byte, []int) {
	return file_runme_runner_v1_runner_proto_rawDescGZIP(), []int{21}
}
...
func (x *ResolveNotebookResponse) GetCommands() *ResolveProgramCommandList {
	if x != nil {
		return x.Commands
	}
	return nil
...
func (x *ResolveNotebookResponse) GetVars() []*ResolveNotebookResponse_VarResult {
	if x != nil {
		return x.Vars
	}
	return nil
...
func (x *MonitorEnvStoreResponseSnapshot_Error) Reset() {
	*x = MonitorEnvStoreResponseSnapshot_Error{}
	mi := &file_runme_runner_v1_runner_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ResolveNotebookResponse_VarResult struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// prompt indicates the resolution status of the env variable.
	Status ResolveNotebookResponse_Status `protobuf:"varint,1,opt,name=status,proto3,enum=runme.runner.v1.ResolveNotebookResponse_Status" json:"status,omitempty"`
	// name is the name of the environment variable.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// original_value is a default value of the environment variable.
	// It might be a value that is assigned to the variable in the script,
...
func (x *ResolveNotebookResponse_VarResult) Reset() {
	*x = ResolveNotebookResponse_VarResult{}
	mi := &file_runme_runner_v1_runner_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResolveNotebookResponse_VarResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResolveNotebookResponse_VarResult) ProtoMessage() {}

func (x *ResolveNotebookResponse_VarResult) ProtoReflect() protoreflect.Message {
	mi := &file_runme_runner_v1_runner_proto_msgTypes[27]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResolveNotebookResponse_VarResult.ProtoReflect.Descriptor instead.
func (*ResolveNotebookResponse_VarResult) Descriptor() ([]byte, []int) {
	return file_runme_runner_v1_runner_proto_rawDescGZIP(), []int{21, 0}
}

func (x *ResolveNotebookResponse_VarResult) GetStatus() ResolveNotebookResponse_Status {
	if x != nil {
		return x.Status
	}
	return ResolveNotebookResponse_STATUS_UNSPECIFIED
}

func (x *ResolveNotebookResponse_VarResult) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ResolveNotebookResponse_VarResult) GetOriginalValue() string {
	if x != nil {
		return x.OriginalValue
	}
	return ""
...
func (x *ResolveNotebookResponse_VarResult) GetResolvedValue() string {
	if x != nil {
		return x.ResolvedValue
	}
	return ""
...
var file_runme_runner_v1_runner_proto_rawDesc = []byte{
	...
	0x2f, 0x70, 0x61, 0x72, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xae, 0x01,
	0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x65, 0x6e, 0x76,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x65, 0x6e, 0x76, 0x73, 0x12, 0x42, 0x0a,
	0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x26, 0x2e, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76,
	0x31, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	,
	...
	0x63, 0x74, 0x88, 0x01, 0x01, 0x12, 0x4a, 0x0a, 0x0e, 0x65, 0x6e, 0x76, 0x5f, 0x73, 0x74, 0x6f,
	0x72, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e,
	0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e,
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x45, 0x6e, 0x76, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x54,
	0x79, 0x70, 0x65, 0x52, 0x0c, 0x65, 0x6e, 0x76, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x54, 0x79, 0x70,
	...
	0x0a, 0x08, 0x5f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x4b, 0x0a, 0x15, 0x43, 0x72,
	...
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x73,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x15, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4c, 0x0a,
	...
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e,
	0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x52, 0x08, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x26, 0x0a, 0x14, 0x44,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x43, 0x0a, 0x07,
	0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x6f, 0x6f, 0x74, 0x12, 0x24, 0x0a, 0x0e, 0x65,
	0x6e, 0x76, 0x5f, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x02, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x0c, 0x65, 0x6e, 0x76, 0x4c, 0x6f, 0x61, 0x64, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x22, 0x4d, 0x0a, 0x07, 0x57, 0x69, 0x6e, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x12, 0x0a, 0x04,
	...
	0x63, 0x6f, 0x6c, 0x73, 0x12, 0x0c, 0x0a, 0x01, 0x78, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x01, 0x78, 0x12, 0x0c, 0x0a, 0x01, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x01, 0x79,
	0x22, 0x9f, 0x06, 0x0a, 0x0e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x65, 0x6e, 0x74, 0x73, 0x12, 0x1c, 0x0a, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f, 0x72,
	...
	0x52, 0x04, 0x65, 0x6e, 0x76, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e,
	0x64, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e,
	0x64, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x18, 0x06, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x74,
	0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03, 0x74, 0x74, 0x79, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x78, 0x65, 0x63,
	...
	0x69, 0x7a, 0x65, 0x88, 0x01, 0x01, 0x12, 0x1e, 0x0a, 0x0a, 0x62, 0x61, 0x63, 0x6b, 0x67, 0x72,
	0x6f, 0x75, 0x6e, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x62, 0x61, 0x63, 0x6b,
	0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f,
	...
	0x31, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67,
	...
	,
	...
	,
	...
	0x12, 0x3f, 0x0a, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2b,
	0x2e, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76, 0x31,
	...
	0x65, 0x12, 0x10, 0x0a, 0x03, 0x65, 0x6e, 0x76, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x03,
	0x65, 0x6e, 0x76, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x69,
	0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x49, 0x64, 0x12, 0x4b, 0x0a, 0x10, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x73, 0x74,
	0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x72,
	0x75, 0x6e, 0x6d, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x53,
	...
	0x37, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x18, 0x2e, 0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e,
	0x76, 0x31, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x48, 0x01, 0x52, 0x07, 0x70, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x0b, 0x6c, 0x61, 0x6e, 0x67,
	0x75, 0x61, 0x67, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6c,
	0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x49, 0x64, 0x22, 0x44, 0x0a, 0x04, 0x4d, 0x6f, 0x64,
	...
	0x50, 0x52, 0x4f, 0x4d, 0x50, 0x54, 0x5f, 0x41, 0x4c, 0x4c, 0x10, 0x01, 0x12, 0x11, 0x0a, 0x0d,
	0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x53, 0x4b, 0x49, 0x50, 0x5f, 0x41, 0x4c, 0x4c, 0x10, 0x02, 0x42,
	0x08, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x70, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0x9e, 0x04, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76,
	...
	0x52, 0x06, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x12, 0x46, 0x0a, 0x08, 0x63, 0x6f, 0x6d, 0x6d,
	0x61, 0x6e, 0x64, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x72, 0x75, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x53, 0x74, 0x61,
	...
	0x70, 0x65, 0x63, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x12, 0x25, 0x0a, 0x0e, 0x6f,
	0x72, 0x69, 0x67, 0x69, 0x6e, 0x61, 0x6c, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x05, 0x20,
	...
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x72, 0x65, 0x73, 0x6f,
	0x6c, 0x76, 0x65, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65,
	...
	0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x4e, 0x0a, 0x06, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x72, 0x75,
	0x6e, 0x6d, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x4d, 0x6f,
	0x6e, 0x69, 0x74, 0x6f, 0x72, 0x45, 0x6e, 0x76, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x2e, 0x45, 0x72,
	0x72, 0x6f, 0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x69,
	0x73, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08,
	...
	0x09, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x35,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x5a, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	...
	,
	...
	0x61, 0x74, 0x65, 0x67, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x72, 0x75,
	...
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x12, 0x37,
	...
	0x31, 0x2e, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x48, 0x01, 0x52, 0x07, 0x70, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x88, 0x01, 0x01, 0x12, 0x1f, 0x0a, 0x0b, 0x6c, 0x61, 0x6e, 0x67, 0x75,
	0x61, 0x67, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6c, 0x61,
	0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x49, 0x64, 0x42, 0x08, 0x0a, 0x06, 0x74, 0x61, 0x72, 0x67,
	0x65, 0x74, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0xa1,
	0x04, 0x0a, 0x17, 0x52, 0x65, 0x73, 0x6f, 0x6c, 0x76, 0x65, 0x4e, 0x6f, 0x74, 0x65, 0x62, 0x6f,
	0x6f, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x63,
	...
	,
	...
	0x10, 0x01, 0x12, 0x26, 0x0a, 0x22, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x55, 0x4e, 0x52,
	0x45, 0x53, 0x4f, 0x4c, 0x56, 0x45, 0x44, 0x5f, 0x57, 0x49, 0x54, 0x48, 0x5f, 0x50, 0x4c, 0x41,
	0x43, 0x45, 0x48, 0x4f, 0x4c, 0x44, 0x45, 0x52, 0x10, 0x02, 0x12, 0x13, 0x0a, 0x0f, 0x53, 0x54,
	...
	,
	...
	0x45, 0x4d, 0x50, 0x5f, 0x46, 0x49, 0x4c, 0x45, 0x10, 0x02, 0x12, 0x19, 0x0a, 0x15, 0x43, 0x4f,
	0x4d, 0x4d, 0x41, 0x4e, 0x44, 0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x54, 0x45, 0x52, 0x4d, 0x49,
	0x4e, 0x41, 0x4c, 0x10, 0x03, 0x12, 0x1d, 0x0a, 0x19, 0x43, 0x4f, 0x4d, 0x4d, 0x41, 0x4e, 0x44,
	0x5f, 0x4d, 0x4f, 0x44, 0x45, 0x5f, 0x44, 0x41, 0x47, 0x47, 0x45, 0x52, 0x5f, 0x53, 0x48, 0x45,
	0x4c, 0x4c, 0x10, 0x04, 0x2a, 0x55, 0x0a, 0x0f, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53,
	...
	,
	...
	,
	...
	0x72, 0x75, 0x6e, 0x6d, 0x65, 0x2f, 0x76, 0x33, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69,
...
var file_runme_runner_v1_runner_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_runme_runner_v1_runner_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_runme_runner_v1_runner_proto_goTypes = []any{
	...
	(ResolveNotebookResponse_Status)(0),                 // 8: runme.runner.v1.ResolveNotebookResponse.Status
	(*Session)(nil),                                     // 9: runme.runner.v1.Session
	(*CreateSessionRequest)(nil),                        // 10: runme.runner.v1.CreateSessionRequest
	(*CreateSessionResponse)(nil),                       // 11: runme.runner.v1.CreateSessionResponse
	(*GetSessionRequest)(nil),                           // 12: runme.runner.v1.GetSessionRequest
	(*GetSessionResponse)(nil),                          // 13: runme.runner.v1.GetSessionResponse
	(*ListSessionsRequest)(nil),                         // 14: runme.runner.v1.ListSessionsRequest
	(*ListSessionsResponse)(nil),                        // 15: runme.runner.v1.ListSessionsResponse
	(*DeleteSessionRequest)(nil),                        // 16: runme.runner.v1.DeleteSessionRequest
	(*DeleteSessionResponse)(nil),                       // 17: runme.runner.v1.DeleteSessionResponse
	(*Project)(nil),                                     // 18: runme.runner.v1.Project
	(*Winsize)(nil),                                     // 19: runme.runner.v1.Winsize
	(*ExecuteRequest)(nil),                              // 20: runme.runner.v1.ExecuteRequest
	(*ProcessPID)(nil),                                  // 21: runme.runner.v1.ProcessPID
	(*ExecuteResponse)(nil),                             // 22: runme.runner.v1.ExecuteResponse
	(*ResolveProgramCommandList)(nil),                   // 23: runme.runner.v1.ResolveProgramCommandList
	(*ResolveProgramRequest)(nil),                       // 24: runme.runner.v1.ResolveProgramRequest
	(*ResolveProgramResponse)(nil),                      // 25: runme.runner.v1.ResolveProgramResponse
	(*MonitorEnvStoreRequest)(nil),                      // 26: runme.runner.v1.MonitorEnvStoreRequest
	(*MonitorEnvStoreResponseSnapshot)(nil),             // 27: runme.runner.v1.MonitorEnvStoreResponseSnapshot
	(*MonitorEnvStoreResponse)(nil),                     // 28: runme.runner.v1.MonitorEnvStoreResponse
	(*ResolveNotebookRequest)(nil),                      // 29: runme.runner.v1.ResolveNotebookRequest
	(*ResolveNotebookResponse)(nil),                     // 30: runme.runner.v1.ResolveNotebookResponse
	nil,                                                 // 31: runme.runner.v1.Session.MetadataEntry
	nil,                                                 // 32: runme.runner.v1.CreateSessionRequest.MetadataEntry
	(*ResolveProgramResponse_VarResult)(nil),            // 33: runme.runner.v1.ResolveProgramResponse.VarResult
	...
	(*ResolveNotebookResponse_VarResult)(nil),           // 36: runme.runner.v1.ResolveNotebookResponse.VarResult
	(*wrapperspb.UInt32Value)(nil),                      // 37: google.protobuf.UInt32Value
	(*v1.Notebook)(nil),                                 // 38: runme.parser.v1.Notebook
}
var file_runme_runner_v1_runner_proto_depIdxs = []int32{
	31, // 0: runme.runner.v1.Session.metadata:type_name -> runme.runner.v1.Session.MetadataEntry
	32, // 1: runme.runner.v1.CreateSessionRequest.metadata:type_name -> runme.runner.v1.CreateSessionRequest.MetadataEntry
	18, // 2: runme.runner.v1.CreateSessionRequest.project:type_name -> runme.runner.v1.Project
	0,  // 3: runme.runner.v1.CreateSessionRequest.env_store_type:type_name -> runme.runner.v1.SessionEnvStoreType
	9,  // 4: runme.runner.v1.CreateSessionResponse.session:type_name -> runme.runner.v1.Session
	9,  // 5: runme.runner.v1.GetSessionResponse.session:type_name -> runme.runner.v1.Session
	9,  // 6: runme.runner.v1.ListSessionsResponse.sessions:type_name -> runme.runner.v1.Session
	1,  // 7: runme.runner.v1.ExecuteRequest.stop:type_name -> runme.runner.v1.ExecuteStop
	19, // 8: runme.runner.v1.ExecuteRequest.winsize:type_name -> runme.runner.v1.Winsize
	3,  // 9: runme.runner.v1.ExecuteRequest.session_strategy:type_name -> runme.runner.v1.SessionStrategy
	18, // 10: runme.runner.v1.ExecuteRequest.project:type_name -> runme.runner.v1.Project
	2,  // 11: runme.runner.v1.ExecuteRequest.command_mode:type_name -> runme.runner.v1.CommandMode
	37, // 12: runme.runner.v1.ExecuteResponse.exit_code:type_name -> google.protobuf.UInt32Value
	21, // 13: runme.runner.v1.ExecuteResponse.pid:type_name -> runme.runner.v1.ProcessPID
	23, // 14: runme.runner.v1.ResolveProgramRequest.commands:type_name -> runme.runner.v1.ResolveProgramCommandList
	5,  // 15: runme.runner.v1.ResolveProgramRequest.mode:type_name -> runme.runner.v1.ResolveProgramRequest.Mode
	3,  // 16: runme.runner.v1.ResolveProgramRequest.session_strategy:type_name -> runme.runner.v1.SessionStrategy
	18, // 17: runme.runner.v1.ResolveProgramRequest.project:type_name -> runme.runner.v1.Project
	23, // 18: runme.runner.v1.ResolveProgramResponse.commands:type_name -> runme.runner.v1.ResolveProgramCommandList
	33, // 19: runme.runner.v1.ResolveProgramResponse.vars:type_name -> runme.runner.v1.ResolveProgramResponse.VarResult
	9,  // 20: runme.runner.v1.MonitorEnvStoreRequest.session:type_name -> runme.runner.v1.Session
	34, // 21: runme.runner.v1.MonitorEnvStoreResponseSnapshot.envs:type_name -> runme.runner.v1.MonitorEnvStoreResponseSnapshot.SnapshotEnv
	4,  // 22: runme.runner.v1.MonitorEnvStoreResponse.type:type_name -> runme.runner.v1.MonitorEnvStoreType
	27, // 23: runme.runner.v1.MonitorEnvStoreResponse.snapshot:type_name -> runme.runner.v1.MonitorEnvStoreResponseSnapshot
	38, // 24: runme.runner.v1.ResolveNotebookRequest.notebook:type_name -> runme.parser.v1.Notebook
	3,  // 25: runme.runner.v1.ResolveNotebookRequest.session_strategy:type_name -> runme.runner.v1.SessionStrategy
	18, // 26: runme.runner.v1.ResolveNotebookRequest.project:type_name -> runme.runner.v1.Project
	23, // 27: runme.runner.v1.ResolveNotebookResponse.commands:type_name -> runme.runner.v1.ResolveProgramCommandList
	36, // 28: runme.runner.v1.ResolveNotebookResponse.vars:type_name -> runme.runner.v1.ResolveNotebookResponse.VarResult
	6,  // 29: runme.runner.v1.ResolveProgramResponse.VarResult.status:type_name -> runme.runner.v1.ResolveProgramResponse.Status
	7,  // 30: runme.runner.v1.MonitorEnvStoreResponseSnapshot.SnapshotEnv.status:type_name -> runme.runner.v1.MonitorEnvStoreResponseSnapshot.Status
	35, // 31: runme.runner.v1.MonitorEnvStoreResponseSnapshot.SnapshotEnv.errors:type_name -> runme.runner.v1.MonitorEnvStoreResponseSnapshot.Error
	8,  // 32: runme.runner.v1.ResolveNotebookResponse.VarResult.status:type_name -> runme.runner.v1.ResolveNotebookResponse.Status
	10, // 33: runme.runner.v1.RunnerService.CreateSession:input_type -> runme.runner.v1.CreateSessionRequest
	12, // 34: runme.runner.v1.RunnerService.GetSession:input_type -> runme.runner.v1.GetSessionRequest
	14, // 35: runme.runner.v1.RunnerService.ListSessions:input_type -> runme.runner.v1.ListSessionsRequest
	16, // 36: runme.runner.v1.RunnerService.DeleteSession:input_type -> runme.runner.v1.DeleteSessionRequest
	26, // 37: runme.runner.v1.RunnerService.MonitorEnvStore:input_type -> runme.runner.v1.MonitorEnvStoreRequest
	20, // 38: runme.runner.v1.RunnerService.Execute:input_type -> runme.runner.v1.ExecuteRequest
	24, // 39: runme.runner.v1.RunnerService.ResolveProgram:input_type -> runme.runner.v1.ResolveProgramRequest
	29, // 40: runme.runner.v1.RunnerService.ResolveNotebook:input_type -> runme.runner.v1.ResolveNotebookRequest
	11, // 41: runme.runner.v1.RunnerService.CreateSession:output_type -> runme.runner.v1.CreateSessionResponse
	13, // 42: runme.runner.v1.RunnerService.GetSession:output_type -> runme.runner.v1.GetSessionResponse
	15, // 43: runme.runner.v1.RunnerService.ListSessions:output_type -> runme.runner.v1.ListSessionsResponse
	17, // 44: runme.runner.v1.RunnerService.DeleteSession:output_type -> runme.runner.v1.DeleteSessionResponse
	28, // 45: runme.runner.v1.RunnerService.MonitorEnvStore:output_type -> runme.runner.v1.MonitorEnvStoreResponse
	22, // 46: runme.runner.v1.RunnerService.Execute:output_type -> runme.runner.v1.ExecuteResponse
	25, // 47: runme.runner.v1.RunnerService.ResolveProgram:output_type -> runme.runner.v1.ResolveProgramResponse
	30, // 48: runme.runner.v1.RunnerService.ResolveNotebook:output_type -> runme.runner.v1.ResolveNotebookResponse
...
func file_runme_runner_v1_runner_proto_init() {
	...
	file_runme_runner_v1_runner_proto_msgTypes[20].OneofWrappers = []any{
		(*ResolveNotebookRequest_KnownId)(nil),
		(*ResolveNotebookRequest_KnownName)(nil),
		(*ResolveNotebookRequest_CellIndex)(nil),
	}
	type x struct{}
